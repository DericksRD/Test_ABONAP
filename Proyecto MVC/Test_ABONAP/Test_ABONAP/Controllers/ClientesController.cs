...
namespace Test_ABONAP.Controllers
{
    public class ClientesController : Controller
    {
        ...
        {
            var aBONAPContext = _context.Clientes.Include(c => c.IdPersonaNavigation).Include(c => c.IdSucursalNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdCliente,FechaCreacion,FechaActualizacion,Codigo,Estado,IdPersona,IdSucursal")] Cliente cliente)
        {
            ...
            ViewData["IdSucursal"] = new SelectList(_context.Sucursales, "IdSucursal", "IdSucursal", cliente.IdSucursal);
            return View(cliente);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,FechaCreacion,FechaActualizacion,Codigo,Estado,IdPersona,IdSucursal")] Cliente cliente)
        {
